...
payload=d.generate_payload(tinytuya_async.CONTROL, {'1': True, '2': 50})

# Optionally you can set separate gwId, devId and uid values
# payload=d.generate_payload(tinytuya_async.CONTROL, data={'1': True, '2': 50}, gwId=DEVICEID, devId=DEVICEID, uid=DEVICEID)
